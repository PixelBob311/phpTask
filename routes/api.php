...
// Route::put('users/{user_id}/services/{service_id}/tarifs/{rate_id}','App\Http\Controllers\RestController@editRate');
Route::put('tarifs/{rate_id}','App\Http\Controllers\RestController@update');